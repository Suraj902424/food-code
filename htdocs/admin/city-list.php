 ...
 <!------------------------------------------------>
                            ...
                            <div id="showrecord">
                                ...
                                <table id="example1" class="table table-striped table-bordered table-hover"
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT p1.*, tbl_state.name AS state_name
                                            FROM $tableName p1
                                            LEFT JOIN tbl_state ON tbl_state.id = p1.state_id 
                                            ORDER BY p1.id DESC";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="order-actions">
                                                        <a href="city.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a>
