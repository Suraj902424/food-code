...
$pageName    = "Size";
$linkName    = "Show All Size";
$editMode    =   "editData";
$addMode    =   "addData";
$tableName   = $tblSize;
$listPageUrl = $urlsizeList;
$imageUrl = $mainPath;
                        ...
                        <div class="panel-body">
                            ...
                            <form id="InsertUpdateForm" role="form" action="" method="post"
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label>Unit</label>
                                        <input type="text" id="" name="unit" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['unit'] : "" ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label>Unit Name</label>
                                        <input type="text" id="" name="unit_name" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['unit_name'] : "" ?>">
                                    </div>
                                </div>
                                <!--image section end-->
                                <div class="form-group row" style="display: none;">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="simple_data[]" id="" multiple>
                                            ...
                                            <option value="unit_name" selected >unit_name</option>
                                        </select>
                                    </div>
                                </div>
                                <hr>
