...
include 'dbc.php';
$pageTitle = "List of Testimonials ";
$pageName = " Testimonial";
$tableName = $tblTestimonial;
$addPageUrl = $urlTestimonial;
$deleteMode = "deleteData";
$returnurl = $urlTestimonialList;
$imageUrl = $mainPath;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="order-actions">
                                                        <a href="testimonial.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a>
