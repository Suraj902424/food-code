...
include 'dbc.php';
$pageTitle = "List of Portfolio Image ";
$pageName = " Portfolio Image";
$tableName = $tblPortfolioImage;
$addPageUrl = $urlPortfolioImage;
$deleteMode = "deleteData";
$returnurl = $urlTeamList;
$imageUrl = $mainPath;
 ...
 <!------------------------------------------------>
                            ...
                            <div id="showrecord">
                                ...
                                <table id="example1" class="table table-striped table-bordered table-hover"
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT $tableName.*, tbl_services.name AS service_name
                                        FROM $tableName 
                                        LEFT JOIN tbl_services ON tbl_services.id = $tableName.service_id
                                        ORDER BY id DESC";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="order-actions">
                                                        <a href="portfolio-image.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a>
