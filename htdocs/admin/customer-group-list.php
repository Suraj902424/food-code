...
include 'dbc.php';
$pageTitle = "List of Customer Group ";
$pageName = " Customer Group";
$tableName = $tblCustomerGroup;
$addPageUrl = $urlCustomerGroup;
$deleteMode = "deleteData";
$returnurl = $urlCustomerGroupList;
$imageUrl = $mainPath;
                            ...
                            <div id="showrecord" class="table-responsive">
                                <table id="example1" class="table table-striped table-bordered table-hover table-responsive"
                                    ...
                                    <tbody>
                                        ...
                                        // Fetching customer data into the array
                                        $sql2 = mysqli_query($conn, "SELECT * FROM $tblGroup") or die(mysqli_error($conn));
                                        $groupAry = [];  // Initialize the array to store customer ID and name
                                        while ($row2 = mysqli_fetch_assoc($sql2)) {
                                            $groupAry[$row2['id']] = $row2['name']; // Store customer name with ID as key
                                        }
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    // Fetching the customer name from the array using the customer ID
                                                    $groupId = $row['group_id']; // Assuming the column is 'customer_id'
                                                    echo isset($groupAry[$groupId]) ? $groupAry[$groupId] : 'Unknown';
                                                    ?></td>
                                                <td>
                                                    <div class="order-actions">
                                                        <!-- <a href="customer-group.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a> -->
