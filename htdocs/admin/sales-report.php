...
include 'dbc.php';
$pageTitle = "List of Sales Report ";
...
<![endif]-->
    ...
    <div id="wrapper">
        ...
        $query = "SELECT product_name, SUM(total_amount) AS total_sales FROM $tableName WHERE 1=1"; // Start with a default true condition
        ...
        // Group by product_id to get the total sales per product
                                        ...
                                        <table id="" class="table table-striped table-bordered table-hover" width="100%">
                                            ...
                                            <tbody id="">
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    $grand_total += $row['total_sales']; // Add each product's total sales to the grand total
                                                ?>
                                                    <tr>
