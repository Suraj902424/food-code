                            ...
                            <form id="InsertUpdateForm" role="form" action="" method="post"
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-6">
                                        <label>festival_name </label>
                                        <input type="text" id="" name="festival_name" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['festival_name'] : "" ?>">
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <label>festival_promo_title </label>
                                        <input type="text" id="" name="festival_promo_title" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['festival_promo_title'] : "" ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-6">
                                        <label>festival_description </label>
                                        <input type="text" id="" name="festival_description" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['festival_description'] : "" ?>">
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <label>festival_start_date </label>
                                        <input type="text" id="" name="festival_start_date" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['festival_start_date'] : "" ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label for="name">festival_end_date</label>
                                        <textarea name="festival_end_date" class="form-control"><?php echo (isset($_GET['id'])) ? $serviceData['festival_end_date'] : "" ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label for="name">festival_status</label>
                                        <textarea name="festival_status" class="editor"><?php echo (isset($_GET['id'])) ? $serviceData['festival_status'] : "" ?></textarea>
                                    </div>
                                </div>
                                
                                  <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label for="name">festival_offer</label>
                                        <textarea name="festival_offer" class="editor"><?php echo (isset($_GET['id'])) ? $serviceData['festival_offer'] : "" ?></textarea>
                                    </div>
                                </div>  
                                
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label for="name">festival_video</label>
                                        <textarea name="festival_video" class="editor"><?php echo (isset($_GET['id'])) ? $serviceData['festival_video'] : "" ?></textarea>
                                    </div>
                                </div>
                                
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label for="name">festival_button_url</label>
                                        <textarea name="festival_button_url" class="editor"><?php echo (isset($_GET['id'])) ? $serviceData['festival_button_url'] : "" ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="display: none;">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="simple_data[]" id="" multiple>
                                            ...
                                            <option value="festival_name" selected>festival_name</option>
                                            <option value="festival_promo_title" selected>festival_promo_title</option>
                                            <option value="festival_description" selected>festival_description</option>
                                            <option value="festival_start_date" selected>festival_start_date</option>
                                            <option value="festival_end_date" selected>festival_end_date</option>
                                            <option value="festival_status" selected>festival_status</option>
                                            <option value="festival_offer" selected>festival_offer</option>
                                            <option value="festival_video" selected>festival_video</option>
                                            <option value="festival_button_url" selected>festival_button_url</option>
