...
include 'dbc.php';
$pageTitle = "List of Menu Category ";
$pageName = " Menu Category";
$tableName = $tblMenuCategory;
$addPageUrl = $urlMenuCategory;
$deleteMode = "deleteData";
$returnurl = $urlMenuCategoryList;
$imageUrl = $mainPath;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="order-actions">
                                                        <a href="menu-category.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a>
