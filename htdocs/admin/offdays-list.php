...
include 'dbc.php';
$pageTitle = "List of Customer OffDays ";
$pageName = " Customer OffDays";
$tableName = $tblOffDays;
$addPageUrl = $urlOffDays;
$deleteMode = "deleteData";
$returnurl = $urlOffDaysList;
$imageUrl = $mainPath;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="order-actions">
                                                        <!-- <a href="offdays.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a> -->
