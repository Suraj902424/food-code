...
include 'dbc.php';
$pageTitle = "Add New Posrtfolio Image";
$pageName    = "Portfolio Image";
$linkName    = "Show All Portfolio Image";
$editMode    =   "editData";
$addMode    =   "addData";
$tableName   = $tblPortfolioImage;
$listPageUrl = $urlPortfolioImageList;
$imageUrl = $mainPath;
                            ...
                            <form id="InsertUpdateForm" role="form" action="" method="post"
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label>Service</label>
                                        <select name="service_id" class="form-control js-source-states">
                                            <option value="">Select Service</option>
                                            <?php
                                               $service_que = "SELECT * FROM tbl_services";
                                               $service_res = mysqli_query($conn, $service_que);
                                               while ($service_row = mysqli_fetch_array($service_res)) {
                                                $selected = isset($serviceData['service_id']) && $serviceData['service_id'] == $service_row['id'] ? 'selected' : '';  
                                            ?>
                                                 <option value="<?= $service_row['id'] ?>"  <?= $selected ?>><?= $service_row['name'] ?></option>
                                            <?php
                                               }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label>Url </label>
                                        <input type="text" id="" name="url" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['url'] : "" ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row" style="display: none;">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="simple_data[]" id="" multiple>
                                            <option value="service_id" selected>service_id</option>
