...
include 'dbc.php';
$pageTitle = "List of Portfolio ";
$pageName = " Portfolio";
$tableName = $tblPortfolio;
$addPageUrl = $urlPortfolio;
$deleteMode = "deleteData";
$returnurl = $urlPortfolioList;
$imageUrl = $mainPath;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="order-actions">
                                                        <a href="portfolio.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a>
