...
$addPageUrl = $urlService;
$deleteMode = "deleteData";
$returnurl = $urlServiceList;
$imageUrl = $mainPath;
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td width="200"><?php echo $row['short_description'] ?></td>
                                                <td>
                                                    <div class="order-actions">
                                                        <a href="service.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a>
                                                        <button type="button" class="btn btn-danger delete-btn"
                                                            data-id="<?= $row['id'] ?>"
                                                            data-table-name="<?= $tableName ?>"
                                                            data-image1="<?= $imagepath . $row['image1'] ?>"
                                                            data-image2="<?= $imagepath . $row['image2'] ?>">
