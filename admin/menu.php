...
$pageName    = "Menu";
$linkName    = "Show All Menu";
$editMode    =   "editData";
$addMode    =   "addData";
$tableName   = $tblMenu;
$listPageUrl = $urlMenuList;
$imageUrl = $mainPath;
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="category_id" class="form-control js-source-states">
                                            ...
                                            <?php
                                            $category_que = "SELECT * FROM tbl_menu_category";
                                            $category_res = mysqli_query($conn, $category_que);
                                            while ($category_row = mysqli_fetch_array($category_res)) {
                                                $selected = isset($serviceData['category_id']) && $serviceData['category_id'] == $category_row['id'] ? 'selected' : '';
                                            ?>
                                                <option value="<?= $category_row['id'] ?>" <?= $selected ?>><?= $category_row['name'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
