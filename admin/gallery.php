            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <!-- Gallery Form -->
                        <form id="InsertUpdateForm" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <input type="text" name="name" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['name'] : ""; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="display: none;">
                                <div class="col-xs-12 col-sm-12">
                                    <input type="text" name="table_name" class="form-control" value="<?php echo $tableName ?>">
                                    <input type="text" name="return_url" class="form-control" value="<?php echo $listPageUrl ?>">
