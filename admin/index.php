    ...
    <div class="login-container">
        <div class="row">
            <div class="col-md-12">
                <div class="text-center m-b-md">
                    ...
                    <small>Login to Admin Console</small>
                </div>
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="" id="loginForm">
                            ...
                            <button style="position:relative; height:34px;" id="loginbtn" type="submit" class="btn btn-success btn-block ">Login</button>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                DEVELOPED BY <?php echo $developerName; ?> <br /> 2018
            </div>
        </div>
    </div>
