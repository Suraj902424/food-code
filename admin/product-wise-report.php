...
include 'dbc.php';
$pageTitle = "List of Product Report ";
...
<![endif]-->
    ...
    <div id="wrapper">
        ...
        // Add condition for product_id if selected
        if (!empty($product_id)) {
                                ...
                                <form method="get">
                                    <div class="col-xs-12 col-sm-5">
                                        <select name="product_id" class="form-control js-source-states">
                                            ...
                                            <?php
                                            $del_sql = mysqli_query($conn, "SELECT * FROM tbl_product") or die(mysqli_error($conn));
                                            while ($del_row = mysqli_fetch_assoc($del_sql)) {
                                                $selected = ($del_row['id'] == $product_id) ? 'selected' : '';
