...
include 'dbc.php';
$pageTitle = "List of Delivery Type ";
$pageName = " Delivery Type";
$tableName = $tblDeliveryType;
$addPageUrl = $urlDeliveryType;
$deleteMode = "deleteData";
$returnurl = $urlDeliveryTypeList;
$imageUrl = $mainPath;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="order-actions">
                                                        <a href="delivery-type.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a>
