...
$tableName = $tblCourseCategory;
$addPageUrl = $urlCourseCategory;
$deleteMode = "deleteData";
$returnurl = $urlCourseCategoryList;
$imageUrl = $mainPath;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="order-actions">
                                                        <a href="course-category.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a>
