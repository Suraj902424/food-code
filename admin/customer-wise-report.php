...
include 'dbc.php';
$pageTitle = "List of Customer Report ";
...
<![endif]-->
    ...
    <div id="wrapper">
        ...
        // Add condition for customer_id if selected
            ...
            <div class="row">
                <div class="">
                    <div class="hpanel">
                                ...
                                <form method="get">
                                    <div class="col-xs-12 col-sm-5">
                                        <select name="customer_id" class="form-control js-source-states">
                                            ...
                                            <?php
                                            $cus_sql = mysqli_query($conn, "SELECT * FROM tbl_customer") or die(mysqli_error($conn));
                                            while ($cus_row = mysqli_fetch_assoc($cus_sql)) {
                                                $selected = ($cus_row['id'] == $customer_id) ? 'selected' : '';
                                                echo "<option value='{$cus_row['id']}' $selected>{$cus_row['name']}</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                        ...
                        <br>
                        <div class="panel-body" id="customerTable">
