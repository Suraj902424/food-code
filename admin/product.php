                        ...
                        <div class="panel-body">
                            ...
                            <form id="InsertUpdateForm" role="form" action="" method="post"
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="category_id" class="form-control js-source-states">
                                            ...
                                            <?php
                                            $cat_que = "SELECT * FROM tbl_product_category";
                                ...
                                <div class="form-group row">
                                    ...
                                    <!-- <div class="col-xs-12 col-sm-6">
                                        <label>Price </label>
                                        <input type="text" id="" name="price" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['price'] : "" ?>">
                                    </div> -->

                                     <div class="col-xs-12 col-sm-6">
                                        <label>price_half </label>
                                        <input type="text" id="" name="price_half" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['price_half'] : "" ?>">
                                    </div>

                                     <div class="col-xs-12 col-sm-6">
                                        <label>price_full </label>
                                        <input type="text" id="" name="price_full" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['price_full'] : "" ?>">
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-6">
                                        ...
                                        <input type="text" id="" name="base_price" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['base_price'] : "" ?>">
                                    </div>
                                    <!-- <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="form-group row" style="display: none;">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="simple_data[]" id="" multiple>
                                            ...
                                            <option value="price_half" selected>price_half</option>
                                            <option value="price_full" selected>price_full</option>
