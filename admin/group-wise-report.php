...
include 'dbc.php';
$pageTitle = "List of Group Report ";
$pageName = " Group Report";
$tableName = $tblOrder;
$addPageUrl = $urlCity;
...
<![endif]-->
    ...
    <div id="wrapper">
        ...
        // Add condition for group_id if selected
        if (!empty($group_id)) {
                            ...
                            <div class="row">
                                <form method="get">
                                    <div class="col-xs-12 col-sm-5">
                                        <select name="group_id" class="form-control js-source-states">
                                            <option value="" selected>Select Group</option>
                                            <?php
                                            $group_sql = mysqli_query($conn, "SELECT * FROM tbl_group") or die(mysqli_error($conn));
