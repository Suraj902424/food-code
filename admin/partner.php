...
$pageName    = "Partner";
$linkName    = "Show All Partners";
$editMode    =   "editData";
$addMode    =   "addData";
$tableName   = $tblPartner;
$listPageUrl = $urlPartnerList;
$imageUrl = $mainPath;
                            ...
                            <form id="InsertUpdateForm" role="form" action="" method="post"
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="partner_type" id="partner_type" class="form-control js-source-states">
                                            <option value="" disabled>Select Category</option>
                                            <option value="Hotel Partner" <?php echo (isset($serviceData['partner_type']) && $serviceData['partner_type'] == 'Hotel Partner') ? 'selected' : ''; ?>>Hotel Partner</option>
                                            <option value="Placement Partner" <?php echo (isset($serviceData['partner_type']) && $serviceData['partner_type'] == 'Placement Partner') ? 'selected' : ''; ?>>Placement Partner</option>
                                            <option value="International Partner" <?php echo (isset($serviceData['partner_type']) && $serviceData['partner_type'] == 'International Partner') ? 'selected' : ''; ?>>International Partner</option>
                                            <option value="Alumni Partner" <?php echo (isset($serviceData['partner_type']) && $serviceData['partner_type'] == 'Alumni Partner') ? 'selected' : ''; ?>>Alumni Partner</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="display: none;">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="simple_data[]" id="" multiple>
                                            ...
                                            <option value="partner_type" selected>partner_type</option>
                                        </select>
