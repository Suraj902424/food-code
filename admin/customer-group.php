...
$editMode    =   "editData";
$addMode    =   "addData";
$tableName   = $tblCustomerGroup;
$listPageUrl = $urlCustomerGroupList;
$imageUrl = $mainPath;
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="hpanel">
                        <div class="panel-body">
                            <!-- Page Form-->
                            <form id="CusgroupForm" role="form" action="" method="post"
                                enctype="multipart/form-data">
                                <input type="hidden" name="case" value="InsertUpdateCusGroup">
                                <input type="hidden" name="id" value="<?php echo (isset($_GET['id'])) ? $serviceData['id'] : "" ?>">

                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label>Group</label>
                                        <select name="group_id" id="" class="form-control js-source-states">
                                            ...
                                            ?>
                                                <option value="<?= $group_row['id'] ?>" <?= $selected ?>><?= $group_row['name'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <!-- <div class="form-group row" style="display: none;">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <input type="text" id="" name="page_name" class="form-control" value="Customer Group">
                                        <select name="simple_data[]" id="" multiple>
                                            <option value="customer_id" selected>customer_id</option>
                                            <option value="group_id" selected>group_id</option>
                                        </select>
                                    </div>
                                </div> -->
                                <hr>
