                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-6">
                                     ...
                                     <div class="col-xs-12 col-sm-6">
                                        ...
                                        <input type="text" id="applicationname" name="category" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['category'] : "" ?>">
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <label>Client</label>
                                        <input type="text" id="applicationname" name="client" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['client'] : "" ?>">
                                    </div>
                                     <div class="col-xs-12 col-sm-6">
                                        <label>location</label>
                                        <input type="text" id="applicationname" name="location" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['location'] : "" ?>">
                                    </div>

                                     <div class="col-xs-12 col-sm-6">
                                        <label>completed_date</label>
                                        <input type="date" id="applicationname" name="completed_date" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['completed_date'] : "" ?>">
                                    </div>

                                    <div class="col-xs-12 col-sm-6">
                                        <label>Project Value</label>
                                        <input type="text" id="applicationname" name="project_value" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['project_value'] : "" ?>">
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <label>Manager</label>
                                        <input type="text" id="applicationname" name="manager" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['manager'] : "" ?>">
                                    </div>

                                    <div class="col-xs-12 col-sm-6">
                                        <label>Designer</label>
                                        <input type="text" id="applicationname" name="designer" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['designer'] : "" ?>">
                                    </div>
                                ...
                                <div class="form-group row" style="display: none;">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="simple_data[]" id="" multiple>
                                            ...
                                            <option value="completed_date" selected>completed_date</option>
                                            <option value="project_value" selected>project_value</option>
