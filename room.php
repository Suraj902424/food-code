...
<main class="container my-5">
    ...
    <?php else: ?>
        <div class="alert alert-info mt-3 text-center">You have no room bookings yet.</div>
    <?php endif; ?>
                ...
                <form action="booking_submit.php" method="POST">
                    <div class="row g-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select room-select" id="roomSelect" name="rooms[]" multiple="multiple" required>
